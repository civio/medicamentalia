  ...
  window.VaccinesPrices = (function() {
    ...
    VaccinesPrices.prototype.onDataLoaded = function(error, _data, _countries) {
      ...
      if ($('#vaccine-prices-all-graph').length > 0) {
        this.setupAllVaccinesGraph();
      }
      if ($('#vaccine-prices-organizations-graph').length > 0) {
        return this.setupOrganizationsGraph();
      }
    };
    ...
    VaccinesPrices.prototype.setupAllVaccinesGraph = function() {
      var graph;
    ...
    VaccinesPrices.prototype.setupOrganizationsGraph = function(data) {
      var graph;
      ...
      graph.setData(this.data.filter(function(d) {
