...
**How are vaccine prices set?** There are two ways. The first is based on costs, that is, the vaccine is priced according to how much it costs to produce it. As with other medicines, pharmaceutical companies and organizations [disagree](http://medicamentalia.org/access/patentes/#cunto-cuesta-crear-un-frmaco) about the real cost of developing a new vaccine. The second, and most common, is linked to how much buyers can or are willing to pay. This is *tiered pricing*, which means that the richer a country is, the more it pays, and is the system advocated by manufacturers, [according](http://www.efpia.eu/topics/industry-economy/access-to-medicines) to the European Federation of Pharmaceutical Industries.
...
The DTP vaccine is sometimes combined with others to try to provide as many immunizations as possible in one go. An example is the pentavalent vaccine which protects -on top diphtheria, tetanus and pertussis,- against Hepatitis B and Hib (anti-Haemophilus influenzae type b, a bacterium that causes pneumonia, respiratory problems, infections and can lead to death). Ukrania (lower-middle income) paid Sanofi almost the same price as Spain (high income): more than 22 euros per dose. If we add the Hepatitis B vaccine to the previous combination we get the hexavalent vaccine. Both Portugal and Spain buy it from GSK, but the Portuguese government pays ten euros more per dose.
...
Laboratories, on the other hand, do not welcome the existence of reference prices with which to compare. Richard Bergström, Director General of the European Federation of Pharmaceutical Industries and Associations (EFPIA), [says](http://www.efpia.eu/topics/industry-economy/pricing-of-medicines) that "the practice of international reference prices prevents setting differentiated pricing for each markets, which is normal in other parts of the world, where it is not only accepted but also welcomed that companies charge lower prices in low- and middle-income countries."
