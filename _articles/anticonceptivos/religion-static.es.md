...
"Prohibido, prohibido y prohibido. Por eso no existe la marcha atrás", rabino Daniel Bitton.

{% include caption.html img="contraceptives/rabinos-1.jpg" fullWidth=true %}

"El semen del hombre no puede estar fuera, no puede ser en vano".

{% include caption.html img="contraceptives/rabinos-2.jpg" fullWidth=true %}

"Los judíos, y especialmente los ortodoxos, saben que es cortar la suerte de uno".
...
"Depende de por qué quieres planificar tu familia. Si es por problemas de salud, lo aceptamos. La primera preocupación del Islam es proteger la vida", Ousman M. Jah, del Consejo Supremo Islámico de Gambia.

{% include caption.html img="contraceptives/imam-1.jpg" fullWidth=true %}

"Pero parar de tener hijos porque no tienes dinero... Odiamos eso, estamos en contra".

{% include caption.html img="contraceptives/imam-2.jpg" fullWidth=true %}

"Somos los hijos de Alá, todos nosotros. Y antes de que Alá envíe a alguien, él provee todas las necesidades para él o ella".
...
"El impulso sexual puede ser cultivado en un camino de autoconomiento y en el desarrollo de la capacidad de autodominio", Amoris Laetitia del Papa Francisco.
